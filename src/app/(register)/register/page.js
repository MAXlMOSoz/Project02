  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className='p-6 space-y-5' >
        ...
        <input type="text" name="txt_lastname" defaultValue={form.txt_firstname} onChange={handleChange} className='w-full border text-black border-black rounded-md px-4 py-2' placeholder='firstname' />
        {form.txt_firstname}
        <input type="text" name="txt_lastname" defaultValue={form.txt_firstname} onChange={handleChange} className='w-full border text-black border-black rounded-md px-4 py-2' placeholder='firstname' />
        {form.txt_firstname}
        <input type="text" name="txt_lastname" defaultValue={form.txt_firstname} onChange={handleChange} className='w-full border text-black border-black rounded-md px-4 py-2' placeholder='firstname' />
